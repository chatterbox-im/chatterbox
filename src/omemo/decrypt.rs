...
impl OmemoManager {
    ...
    pub(crate) async fn handle_decryption_failure(&mut self, sender_jid: String, device_id: u32, session_error: crate::omemo::session::SessionError) -> Result<String, OmemoError> {
        ...
        if let crate::omemo::session::SessionError::DoubleRatchetError(ref ratchet_error) = session_error {
            if let crate::omemo::protocol::DoubleRatchetError::CryptoError(ref crypto_error) = ratchet_error {
